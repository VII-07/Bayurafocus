...
} from "./chunk-TT6YSZJL.js";
import {
  BarsOutlined_default,
  LeftOutlined_default,
  RightOutlined_default
} from "./chunk-C3ADNQSQ.js";
import {
  require_classnames
} from "./chunk-AX3W7U4N.js";
import {
  require_react_is
} from "./chunk-OFBEJY3P.js";
import {
  _objectSpread2
...
var SiderContext = React3.createContext({});
var generateId = (() => {
  let i = 0;
  return function() {
...
var Sider = React3.forwardRef((props, ref) => {
  const {
  ...
  const {
    siderHook
  } = (0, import_react2.useContext)(LayoutContext);
  const [collapsed, setCollapsed] = (0, import_react2.useState)("collapsed" in props ? props.collapsed : defaultCollapsed);
  const [below, setBelow] = (0, import_react2.useState)(false);
  ...
  const responsiveHandlerRef = (0, import_react2.useRef)();
  ...
  const renderSider = () => {
    ...
    const zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? React3.createElement("span", {
      onClick: toggle,
    ...
    }, trigger || React3.createElement(BarsOutlined_default, null)) : null;
    const iconObj = {
      expanded: reverseArrow ? React3.createElement(RightOutlined_default, null) : React3.createElement(LeftOutlined_default, null),
      collapsed: reverseArrow ? React3.createElement(LeftOutlined_default, null) : React3.createElement(RightOutlined_default, null)
    };
    const status = collapsed ? "collapsed" : "expanded";
    const defaultTrigger = iconObj[status];
    const triggerDom = trigger !== null ? zeroWidthTrigger || React3.createElement("div", {
    ...
    return React3.createElement("aside", Object.assign({
      className: siderCls
    }, divProps, {
      style: divStyle,
      ref
  ...
  return React3.createElement(SiderContext.Provider, {
    value: contextValue
  }, renderSider());
});
if (true) {
...
function generator(_ref) {
  ...
  return (BasicComponent) => {
    const Adapter = React4.forwardRef((props, ref) => React4.createElement(BasicComponent, Object.assign({
      ref,
      suffixCls,
      tagName
    }, props)));
...
var Basic = React4.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    suffixCls,
    className,
  ...
  return wrapSSR(React4.createElement(TagName, Object.assign({
    className: (0, import_classnames2.default)(customizePrefixCls || prefixWithSuffixCls, className, hashId),
    ref
  }, others)));
});
var BasicLayout = React4.forwardRef((props, ref) => {
  const {
    direction
  } = React4.useContext(ConfigContext);
  const [siders, setSiders] = React4.useState([]);
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  return wrapSSR(React4.createElement(LayoutContext.Provider, {
    value: contextValue
  }, React4.createElement(Tag, Object.assign({
    ref,
...
//# sourceMappingURL=chunk-UJL7Z5FF.js.map
